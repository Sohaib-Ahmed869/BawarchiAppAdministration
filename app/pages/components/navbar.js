    ...
    return (
        <nav className="bg-dark-800 text-white py-4 shadow-md bg-black border-b border-gray-900">
            <div className="container mx-auto flex justify-between items-center">
                ...
                <div className={`xl:hidden absolute top-0 right-4 gap-4 ${showDropdown ? 'block' : 'hidden'}`}>
                    {
                        isLogged && (
                            <ul className="flex gap-4 flex-col bg-white text-black absolute right-7 top-10 p-4 rounded-md shadow-md border border-gray-900 w-40">
                                ...
                                ><a href="/category/category-add">Add Category</a></li>
                                <li
                                className='cursor-pointer border-b border-gray-400 pb-2'
                                ><a href="/category/category-view">View Category</a></li>
                                <li
                                className='cursor-pointer border-b border-gray-400 pb-2'
                                ><a href="/product/product-add">Add Product</a></li>
                                <li
                                className='cursor-pointer border-b border-gray-400 pb-2'
