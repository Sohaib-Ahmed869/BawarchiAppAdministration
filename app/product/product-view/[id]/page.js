            ...
            <main className="container mx-auto px-4 py-8 flex flex-col md:flex-row justify-center items-center gap-4">
                ...
                <div className="w-full md:w-2/3 px-4 py-6  rounded-md shadow-md bg-black bg-opacity-50 border border-gray-700 rounded p-4 h-auto flex flex-col justify-center">
                    ...
                    <form className="flex flex-col gap-4 mt-4" onSubmit={(e) => {
                        ...
                        <input type="text" className="p-2 bg-gray-700 rounded " placeholder="Name" value={product.Name} onChange={(e) => setProduct({ ...product, Name: e.target.value })} disabled/>
                        <p className='text-gray-400 text-right text-sm'>Name cannot be changed</p>
