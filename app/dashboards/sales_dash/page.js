      ...
      {!loading && (
        <div>
          ...
          <div className="container mx-auto mt-4 p-4 bg-gray-900 rounded-md shadow-md">
            ...
            <form className="flex justify-center">
              <input
                ...
                className="form-control mt-3 mb-2 p-2 rounded-md border text-white bg-gray-600 border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-600"
              />
            </form>
          ...
          <div className="container mx-auto mt-4 p-4 bg-gray-900 rounded-md shadow-md">
            ...
            <form className="flex justify-center">
              <select
                className="form-control mt-3 mb-2 p-2 rounded-md border text-white bg-black border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-600"
                value={month}
